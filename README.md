...
Software engineer at **[NutriScan](https://nutriscan.app/)**, an AI nutrition tracker on iOS and Android. I work across the app, the backend services, the model pipeline that reads a plate of food, and the infrastructure they run on.
...
**Shipping it.** Releases to the App Store and Play Store, over-the-air Flutter updates for anything that can skip review, scheduled jobs for auto-logging and notifications, subscriptions and webhooks, crash and analytics pipelines.
